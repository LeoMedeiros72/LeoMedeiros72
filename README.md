...
**Cientista de Dados com 4+ anos transformando dados em resultados:**  
- ⚡ **Otimização de processos**: Reduzi 30% do tempo de processamento com automações em Python + BigQuery  
- 📊 **Visualização estratégica**: Dashboards que diminuíram 15% o tempo de análise de stakeholders  
- 🤖 **Machine Learning**: Modelos preditivos com 25% mais precisão em cenários reais  

*Minha formação em educação me dá a habilidade única de explicar conceitos complexos de forma simples.*
